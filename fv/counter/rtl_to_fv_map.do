...
# Generated on: Sun Feb 01 13:12:04 IST 2026 (Sun Feb 01 07:42:04 UTC 2026)
...
add_search_path /home/install/TTTC_Cadence_labs/LIBS/timing -library -both
read_library -liberty -both \
    /home/install/TTTC_Cadence_labs/LIBS/timing/slow.lib.gz
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/install/TTTC_Cadence_labs/GENUS_FLOW/counter.v
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#  1      scan_enable                    shift_enable     true       false       port        none                       true                  true          auto       
#  2      TM                             test_mode        true       true        port        none                       false                 true          auto       
#  3      reset                          test_mode        true       true        port        none                       false                 true          auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
