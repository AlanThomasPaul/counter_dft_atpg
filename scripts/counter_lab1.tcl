...
###############################################################################
  ...
  report_scan_registers    > ./REPORTS/DFTregs_final.rpt
  report_scan_setup        > ./REPORTS/DFTsetup_final.rpt
  report_scan_chains       > ./REPORTS/DFTchains_final.rpt
  write_scandef            > ./REPORTS/scanDEF.def
...
###############################################################################
  ...
  write_dft_atpg \
      -library /home/user13/tttc_workshop/LIBS/atpg/include_libraries.v \
      -ncsim_library /home/install/TTTC_Cadence_labs/LIBS/verilog/include_libraries_sim.v \
      -directory MODUS_RUN_COUNTER
